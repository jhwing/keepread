...
//			}
		...
		public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
			Log.d(TAG, "left,top,dx,dy" + left + "," + top + "," + dx + "," + dy);
//			onPanelDragged(top);
//			invalidate();
		}
...
//			invalidate();
		...
		public int getViewVerticalDragRange(View child) {
			Log.d(TAG, "getViewVerticalDragRange" + child);
			return mSlideRange;
		}
		...
		public int clampViewPositionVertical(View child, int top, int dy) {
			...
			Log.d(TAG, "clampViewPositionVertical top is " + top + " dy is " + dy + "newLeft " + newLeft);
			return newLeft;
		}
